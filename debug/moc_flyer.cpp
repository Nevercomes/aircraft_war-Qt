...
struct qt_meta_stringdata_Flyer_t {
    QByteArrayData data[1];
    char stringdata0[6];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Flyer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Flyer_t qt_meta_stringdata_Flyer = {
    {
QT_MOC_LITERAL(0, 0, 5) // "Flyer"
...
const QMetaObject Flyer::staticMetaObject = {
    { &QGraphicsObject::staticMetaObject, qt_meta_stringdata_Flyer.data,
      qt_meta_data_Flyer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Flyer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Flyer.stringdata0))
